...
CREATE TABLE users (
    ...
    created_at timestamp without time zone NOT NULL,
    updated_at timestamp without time zone NOT NULL,
    CONSTRAINT email_must_be_comany_email CHECK (((email)::text ~* '[A-Za-z0-9._%0]+@example.com'::text))
);
...
INSERT INTO schema_migrations (version) VALUES ('20150808101545');

INSERT INTO schema_migrations (version) VALUES ('20150808114414');

INSERT INTO schema_migrations (version) VALUES ('20150808121010');

INSERT INTO schema_migrations (version) VALUES ('20150808130414');
